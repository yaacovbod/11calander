  ...
  },
  {
    ...
    items: [
      ...
      { start: '20260616', end: '20260617', day: 'יום שלישי', display: '16/06/2026', events: [
        { title: 'יום סוף שנה באקווה כיף 🌊', cat: 'trip', tags: ['אקווה כיף'] },
      ]},
      ...
      { start: '20260630', end: '20260701', day: 'יום שלישי', display: '30/06/2026', events: [
        { title: 'בגרות באנגלית 3 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '10:00' },
        { title: 'בגרות באנגלית 5 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '10:00' },
        { title: 'בגרות באנגלית 4 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '12:30' },
      ]},
    ],
  },
  {
    ...
    items: [
      { start: '20260706', end: '20260707', day: 'יום שני', display: '06/07/2026', events: [
        { title: 'בגרות במתמטיקה 3 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '13:00' },
        { title: 'בגרות במתמטיקה 4 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '13:00' },
        { title: 'בגרות במתמטיקה 5 יח"ל (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '13:00' },
      ]},
      { start: '20260709', end: '20260710', day: 'יום חמישי', display: '09/07/2026', events: [
        { title: 'בגרות בלשון (מועד ב\')', cat: 'bagrut', tags: ['בגרות', 'מועד ב\''], time: '10:00' },
      ]},
    ],
  },
]
